function compareEmailsAndShowAlert() {
    ...
    var data2 = sheet2.getRange("A:H").getValues(); // Update the range to include columns E and H
    ...
    for (var i = 1; i < data2.length; i++) {
      ...
      var status = data2[i][7]; // Column H contains status
    ...
    if (foundEmails.length > 0) {
      message += "Found Emails (" + foundEmails.length + "):\n";
    ...
    if (notFoundEmails.length > 0) {
      message += "\nNot Found Emails (" + notFoundEmails.length + "):\n";
